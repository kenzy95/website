...
Une promesse d'appel formulée vaguement par email ne constitue pas un rendez-vous. Date et heure précises, validées par les deux parties via une invitation d'agenda : voilà ce qui compte. Ce blocage formel augmente drastiquement le taux de présence le jour de la visioconférence ou de l'appel téléphonique.
...
Voici un exemple concret de fiche de rendez-vous transmise au client :
...
Le modèle de paiement au rendez-vous cache souvent un piège redoutable. Si le prestataire ne gagne sa vie qu'à la condition de décrocher un appel, il subit une pression financière énorme. Ses équipes auront tendance à forcer la main des prospects, avec des formulations vagues ou des promesses irréalistes pour obtenir un accord de principe. Le résultat se lit immédiatement dans l'agenda de vos commerciaux : ils enchaînent les visioconférences avec des interlocuteurs fuyants, agacés ou hors cible. La quantité prime sur la qualité, ce qui détruit la rentabilité de l'opération.
