...
- [Simulateur officiel URSSAF salaire brut / net / coût employeur](https://mon-entreprise.urssaf.fr/simulateurs/salaire-brut-net) : pour vérifier le coût chargé réel d'un SDR sur votre cas.
- [Welcome to the Jungle](https://www.welcometothejungle.com/fr) : grilles de salaires et annonces SDR publiées en France.
- [LinkedIn Sales Navigator](https://business.linkedin.com/sales-solutions/sales-navigator) : la grille tarifaire publique de l'outil de base du métier.
