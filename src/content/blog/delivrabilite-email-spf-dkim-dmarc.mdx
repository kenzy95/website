...
C'est un travail d'infrastructure exigeant, souvent invisible pour le client final. C'est aussi celui que nous prenons en charge de bout en bout : la partie la moins glamour de la prospection, mais celle qui conditionne tout le reste.
