...
/** Reference Kenzy (section Gestion complete) : orange #ff5005 / sable / periwinkle. */
const DEFAULT_URL =
...
/** Scene ShaderGradient. Chunk lourd charge dynamiquement par ShaderBg. */
export default function ShaderScene({ urlString = DEFAULT_URL }: { urlString?: string }) {
  return (
